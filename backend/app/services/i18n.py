...
LANDING_TEXT = {
    "vi": {
        ...
        "hint_day_doctor": "Ngày mờ là ngày bác sĩ này nghỉ hoặc đã kín lịch.",
    ...
    "en": {
        ...
        "hint_day_doctor": "Greyed days are when this doctor is off or fully booked.",
    ...
    "ja": {
        ...
        "hint_day_doctor": "薄い日付はこの医師が不在または満席です。",
